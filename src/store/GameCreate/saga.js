...
import {
  ...
  CREATE_GAME_SUCCESS,
  JOIN_GAME_WITH_CODE,
  JOIN_GAME_WITH_CODE_ERROR,
  JOIN_GAME_WITH_CODE_SUCCESS,
  CREATE_RANDOM_GAME,
  CREATE_RANDOM_GAME_ERROR,
  CREATE_RANDOM_GAME_SUCCESS,
  CREATE_GAME_WITH_AI,
  CREATE_GAME_WITH_AI_ERROR,
  CREATE_GAME_WITH_AI_SUCCESS,
  GET_CURRENT_GAME,
} from './types'
import {
  createCode,
  ...
  try {
    ...
    if (res.code) {
      ...
      yield put({
        ...
        payload: { code: res.code, gameId: res.gameId },
      })
    }
  } catch (e) {
